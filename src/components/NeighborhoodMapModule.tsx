...
const NeighborhoodMapModule: React.FC<NeighborhoodMapModuleProps> = ({
  ...
  const loadMap = () => {
    ...
    // Initialize MapBox map after load
    setTimeout(() => {
        ...
        new mapboxgl.Marker({ color: '#b19762' })
          ...
          .setPopup(
            new mapboxgl.Popup().setHTML(
              '<h3>Villa Du Cacique</h3><p>31 Cacique, Casa de Campo</p>'
            )
          )
          .addTo(map);
      ...
      <div className="container-luxury">
        <div className="text-center mb-12">
          ...
          <p
            ...
            style={{ color: '#6b6b6b' }}
          >
            Casa de Campo's most exclusive address with world-class amenities at
            your doorstep
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="mb-6">
              <h3 className="text-2xl font-semibold mb-4 flex items-center gap-2">
                <Clock size={24} style={{ color: '#b19762' }} /> Your 5-Minute
                Life
              </h3>
